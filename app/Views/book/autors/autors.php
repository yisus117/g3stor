      ...
      <div class="table-title gap-4" style="outline: 3px solid <?= config("G3stor")->mainColor ?> ;background-color: <?= config("G3stor")->secondColor ?>">
        ...
        <div class="row">
          <div class="col-6  d-flex align-items-center justify-content-between">
            <a href="<?= base_url(route_to("autors")) ?>" class="title-hover no_wrap d-inline h3 text-sm-center text-md-start text-white">
              Autores
          ...
          <div class="col-6  ">
            <a href="<?= base_url(route_to("autors_create")) ?>" class="btn btn-secondary p-2 px-3 mt-1 d-flex align-items-center gap-2 " style="color: white; background-color: <?= config("G3stor")->mainColor ?>" title="Agregar un nuevo registro">
              ...
              <tr>
                ...
                <td>
                  <span class=" px-2 py-1 fw-bold  <?= $autor->estado == "1" ? "bg-success text-white text-nowrap" : ($autor->estado === "2" ? "bg-warning text-dark text-nowrap" : "bg-danger") ?>">
                    <?= $autor->estado == "1" ? "estado" : ($autor->estado === "2" ? "Inactivo" : "eliminado") ?>
                  </span>
                </td>
                <td class="">
                  <div class="d-flex f-row gap-2 mx-0 ">
                    <a href="<?= $autor->getEditLine($autor->id_autor) ?>" name="update" class="btn btn-secondary text-white update px-2 py-1 h-4 d-flex justify-content-center align-items-center">
                      <i class="fa-solid fa-edit fs-6"></i>
                    </a>
                    <button type="button" data-name="<?= $autor->primer_nombre ?> <?= $autor->primer_apellido ?>" class="btn btn-danger delete text-white px-2 py-1">
